...
% 5. Apply the hand-tuned zoomed axes, legend, and publication style.
...
markFrequencies = [31600, 630, 1, 0.5, 15e-3, 100e-3, 15e-3, 10e-3];  % Hz
% Matching tolerance for each marked frequency.
tolFreq = [1e3, 50, 5, 1e-3, 0.2, 10e-3, 1.5e-3, 0e-3];  % Hz
...
outputFileName = fullfile(figuresFolder, sprintf('SOC-%sF_Zoomed.pdf', capNumber));
...
%
% The first frequency point within tolerance is used, matching the original
% plotting behavior.
