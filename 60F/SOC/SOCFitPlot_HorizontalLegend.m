...
hold on 
h_header_meas = plot(NaN, NaN, 'LineStyle', 'none', 'Marker', 'none', 'DisplayName', '\bf{Measured}');
h_header_fit  = plot(NaN, NaN, 'LineStyle', 'none', 'Marker', 'none', 'DisplayName', '\bf{Fitted}');
...
all_handles = [h_header_meas, h_measured, h_header_fit, h_fitted];
...
leg.Title.String = '';              % No main title needed
