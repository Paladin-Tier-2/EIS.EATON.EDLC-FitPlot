...
initial_guess = [7.43197184e-03, 2.96623142e+03, 1.51505406e+02, 9.62423346e-01,
 1.31769097e-02, 6.75757272e-01]  # Updated initial guesses
...
try:
    ...
    saveCSV(subfolder_path + 'fitted_dataBLA.csv', frequencies, Z_fit)
    ...
    error_df.to_csv(subfolder_path + 'impedance_fit_errors.csv', index=False)
    print("Errors saved to impedance_fit_errors.csv")
    ...
    rmse_df.to_csv(subfolder_path + 'rmse_value.csv', index=False)
    print("RMSE value saved to rmse_value.csv")
