...
capFolder = fullfile(repoRoot, '400F'); % Directly target the 60F folder
if ~isfolder(capFolder)
    error('The folder "400F" was not found at %s', repoRoot);
end
...
capNumber = '400'; % Hardcoded for this script
...
if ~isempty(allDataTable)
    ...
    outputCsvFile = fullfile(capFolder, 'impedance_data_400F.csv');
