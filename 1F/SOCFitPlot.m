...
markFrequencies = [31600, 630,2,15e-3,100e-3];
%%% Tolerance to find the frequence
tolFreq = [1e3,50,0.5,1e-3,10e-3];
...
% Ensure the points are connected within the same plot
axes(gca);
...
outputFileName = sprintf('%s/SOC-Fit%sF_Full.pdf', FiguresFol, capNumber);
