...
outputFileName = fullfile(figuresFolder, sprintf('SOC-New%sF_Single.pdf', capNumber));
...
% Parameters
% ----------
% textValue : char or string
%     Text such as "0,40".
%
% Returns
% -------
% values : double row vector
%     Numeric SOC values. Empty text returns [].
